...
public class AllyRegistry {
	...
	public static final Supplier<AttachmentType<Boolean>> EFFECT_ACTIVE = ATTACHMENT_TYPES.register("effect_active", () -> AttachmentType.builder(() -> false).serialize(Codec.BOOL.fieldOf("active")).sync(ByteBufCodecs.BOOL).build());
